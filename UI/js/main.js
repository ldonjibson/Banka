...
const menumobil = document.getElementById('mobile-m').style.display = 'none';
const menuToggle = () => {
...
// load login button
const loginLoad = () => {
  const toLoadlogin = document.getElementById('login');
...
const registerLoad = () => {
  const toLoadregister = document.getElementById('register');
...
const cretBank = () => {
  const formBank = document.getElementById('create-bk-acc').value;
  const cretBnkresult = document.getElementById('createbank');
...
const bankView = () => {
  const chgbank = document.getElementById('bank-op').value;
  if (chgbank === 'profile') {
...
// profile page codes
const revealImgForm = () => {
  const imgForm = document.getElementById('edit-image');
  if (imgForm) {
...
const bankAdminView = () => {
  const chgbadmin = document.getElementById('bank-admin').value;
  if (chgbadmin === 'users') {
...
const bankStaffView = () => {
  const chgbadmin = document.getElementById('bank-staff').value;
  if (chgbadmin === 'main') {
...
const createUserStaff = () => {
  const getForm = document.getElementById('create-user-profile');
  let formValu = '';
  let i;
...
const adminUpdate = () => {
  const xx = document.getElementById('admin-toggle-user-edit');
...
const adminchangePassword = () => {
  const getpassform = document.getElementById('adminedit-changepassword');
  let formValu = '';
  let i;
...
const adminDrCrUpdate = () => {
  const xx = document.getElementById('credit-debit');
  if (xx.getAttribute('class') === 'hide') {
    // this shows the form
    xx.removeAttribute('class');
    xx.style.display = 'block';
...
const creditDebit = () => {
  const getvaluetodrcr = document.getElementById('credit-debit').elements[0].value;
  console.log(getvaluetodrcr);
  const x = document.getElementById('balance').innerHTML;
