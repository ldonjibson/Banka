...
// TO BE USED FOR REFACTORE IF POSIBLE
// const generateDbTable = (dataTable) => {
// 	return new Promise((resolve, reject) =>{
// 		clienty.query(dataTable, (err, res) => {
// 				if (err){
// 					console.log(err);
// 				}else {
// 					console.log(`created the table with success`);
// 			}
// 		});
// 	})
// }

// generateDbTable(createUsersTable)
// .then(result => generateDbTable(createAccountTable)
// 	.then(result => generateDbTable(createTransactionTable)))
